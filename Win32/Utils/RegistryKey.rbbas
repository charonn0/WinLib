...
Protected Class RegistryKey
	...
	#tag Method, Flags = &h0
		Sub Value(SubKeyName As String, RegType As Integer = 0, Assigns NewValue As Variant)
		  ...
		  If RegType = 0 Then
		    ...
		    Case Variant.TypeCString, Variant.TypeString, Variant.TypeWString
		      ...
		      Me.Value(SubKeyName, REG_SZ) = NewValue.StringValue
		      Return
		  ...
		  Else
		    ...
		    Case REG_BINARY, REG_SZ, REG_MULTI_SZ
		      data = New MemoryBlock(NewValue.StringValue.LenB)
		      data.StringValue(0, data.Size) = NewValue.StringValue
