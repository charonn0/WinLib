...
Inherits WMListener
		  ...
		  #If TargetWin32 Then
		    ...
		    Case WM_CHANGECBCHAIN
		      ...
		      If Integer(WParam) = NextViewerWindow Then
		        ...
		        Return True
		      Else
		        Call WinLib.User32.SendMessage(NextViewerWindow, Message, WParam, LParam)
		        Return True
		      End If
	...
	#tag Method, Flags = &h1000
		Sub Constructor(ParentHandle As Integer = 0)
		  ...
		  #If TargetWin32 Then NextViewerWindow = WinLib.User32.SetClipboardViewer(Me.ParentWindow)
		End Sub
	#tag EndMethod

	#tag Method, Flags = &h1
		Protected Sub Destructor()
		  #If TargetWin32 Then Call WinLib.User32.ChangeClipboardChain(Me.ParentWindow, Me.NextViewerWindow)
		  Super.Destructor()
		End Sub
	#tag EndMethod
