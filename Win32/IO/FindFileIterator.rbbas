		  ...
		  #If TargetWin32 Then
		    ...
		    If FindHandle <= 0 Then
		      If System.IsFunctionAvailable("FindFirstFileExW", "Kernel32") Then
		        ...
		        FindHandle = Win32.Libs.Kernel32.FindFirstFileEx(namepattern, 0, data, 0, Nil, flags)
		      Else
		        FindHandle = Win32.Libs.Kernel32.FindFirstFile(NamePattern, data)
		      End If
		      mLastError = Win32.LastError()
		    ElseIf Win32.Libs.Kernel32.FindNextFile(FindHandle, data) Then
		      mLastError = 0
		    Else
		      mLastError = Win32.LastError()
		    End If
