...
Protected Module Win32
	#tag Method, Flags = &h1
		Protected Function AddWindowMessageHandler(MessageID As Integer, Handler As WindowMessageHandler) As Integer
	...
	#tag Method, Flags = &h1
		Protected Sub RemoveWindowMessageHandler(HandlerID As Integer)
