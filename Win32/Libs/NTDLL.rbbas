...
Protected Module NTDLL
	#tag ExternalMethod, Flags = &h1
		Protected Soft Declare Sub NtQueryInformationFile Lib "NTDLL" (fHandle As Integer, ByRef status As Win32 . Libs . IO_STATUS_BLOCK, FileInformation As Ptr, FILength As UInt32, InfoClass As Int32)
