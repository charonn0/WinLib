...
Protected Module Consts
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			...
			End Get
		#tag EndGetter
		Protected FILE_ALL_ACCESS As Integer
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			...
			End Get
		#tag EndGetter
		Protected FILE_GENERIC_READ As Integer
	#tag EndComputedProperty
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			...
			End Get
		#tag EndGetter
		Protected PROCESS_QUERY_LIMITED_INFORMATION As Integer
	#tag EndComputedProperty
