...
Protected Class Win32Waiter
	#tag Method, Flags = &h21
		Private Sub CallBackHandler(parameter As Ptr, timedOut As Boolean)
		  ...
		  Call WinLib.User32.PostMessage(HWND_BROADCAST, msg.MessageID, Nil, Nil)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub Destructor()
		  Call WinLib.Kernel32.UnregisterWait(WaitHandle)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub Wait(WaitObject As Integer)
		  ...
		  If Not WinLib.Kernel32.RegisterWaitForSingleObject(WaitHandle, WaitObject, callback, Nil, &hFFFFFFFF, WT_EXECUTEONLYONCE) Then
		    Me.LastError = WinLib.GetLastError()
		    Break
		  End If
		End Sub
	#tag EndMethod
