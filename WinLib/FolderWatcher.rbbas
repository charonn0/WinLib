...
Inherits Win32Waiter
	#tag Event
		Sub Signalled()
		  ...
		  'Dim sz As Integer
		  'Dim i As Integer
		  'Dim path As String = "//?/" + ReplaceAll(RootDir.AbsolutePath, "/", "//")
		  ...
		  'f = GetFolderItem(RootDir.AbsolutePath + name)
	...
	#tag Method, Flags = &h0
		Sub Destructor()
		  Super.Destructor()
		  Call WinLib.Kernel32.FindCloseChangeNotification(WatchHandle)
		End Sub
	#tag EndMethod
	...
	#tag Method, Flags = &h0
		Sub Watch()
		  ...
		  WatchHandle = WinLib.Kernel32.FindFirstChangeNotification(Me.RootDir.AbsolutePath, True, allFilters)
