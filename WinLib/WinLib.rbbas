...
Protected Module WinLib
	...
	#tag Method, Flags = &h1
		Protected Function FormatError(WinErrorNumber As Integer) As String
		  ...
		  #If TargetWin32 Then
		    ...
		    If WinLib.Kernel32.FormatMessage(FORMAT_MESSAGE_FROM_SYSTEM, 0, WinErrorNumber, 0 , Buffer, Buffer.Size, 0) <> 0 Then
	...
	#tag Method, Flags = &h1
		Protected Function GetLastError() As Integer
		  #If TargetWin32 Then
		    Return WinLib.Kernel32.GetLastError()
		  #endif
		End Function
	#tag EndMethod
	...
	#tag Method, Flags = &h1
		Protected Function GetSystemMetric(Index As Integer) As Integer
		  #If TargetWin32 Then
		    Return WinLib.User32.GetSystemMetrics(Index)
		  #endif
		End Function
	#tag EndMethod
		...
		#tag Getter
			Get
			  #If TargetWin32 Then
			    ...
			    Dim i As Integer
			    Do
			      i = WinLib.Kernel32.GetCurrentDirectory(mb.Size, mb)
	...
	#tag ComputedProperty, Flags = &h1
		#tag Getter
			Get
			  #If TargetWin32 Then
			    Return WinLib.Kernel32.GetCurrentProcess()
			  #endif
			End Get
		#tag EndGetter
