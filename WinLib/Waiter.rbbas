...
Protected Class Waiter
	#tag Method, Flags = &h21
		Private Shared Sub DefWaitProc(Parameter As Ptr, WaitFired As Boolean)
		  ...
		  If Waiters.HasKey(token) Then
		    ...
		    Dim w As WinLib.Waiter = Waiters.Value(token)
	...
	#tag Method, Flags = &h0
		Function WaitOn(Waitable As Integer) As Boolean
		  ...
		  Return Win32.Kernel32.RegisterWaitForSingleObject(mHandle, Waitable, AddressOf DefWaitProc, Ptr(token), Timeout, 0)
		End Function
	#tag EndMethod
